...
const en = {
  ...
  "inbounds.transportPath": "Path",
  "inbounds.transportHost": "Host",
  "inbounds.grpcServiceName": "Service name",
  ...
  "clients.selectAll": "Select all filtered clients",
  "clients.selectClient": "Select {{name}}",
  "clients.selectedCount": "Selected: {{count}}",
  "clients.bulkEnable": "Enable",
  "clients.bulkDisable": "Disable",
  "clients.bulkReset": "Reset traffic",
  "clients.bulkDelete": "Delete",
  "clients.clearSelection": "Clear",
  "clients.bulkFailures": "Failed clients",
  "clients.bulkSummary": "Completed: {{success}}, failed: {{failed}}",
  "clients.bulkRequestFailed": "Bulk operation failed",
  "clients.bulkDeleteTitle": "Delete selected clients?",
  "clients.bulkDeleteBody": "{{count}} selected clients will be permanently removed.",
  "clients.bulkDeleteConfirm": "Delete clients",
  "clients.bulkResetTitle": "Reset selected traffic?",
  "clients.bulkResetBody": "Traffic counters for {{count}} selected clients will be reset to zero.",
  "clients.bulkResetConfirm": "Reset traffic",
  ...
  "settings.notifications.smtp": "SMTP email",
  "settings.notifications.smtpHint": "Send alerts through a secure mail server",
  "settings.notifications.telegram": "Telegram",
  "settings.notifications.telegramHint": "Send alerts through a Telegram bot",
  "settings.notifications.host": "SMTP host",
  "settings.notifications.port": "SMTP port",
  "settings.notifications.security": "Connection security",
  "settings.notifications.timeout": "Provider timeout",
  "settings.notifications.starttls": "STARTTLS",
  "settings.notifications.implicitTls": "Implicit TLS",
  "settings.notifications.sender": "Sender",
  "settings.notifications.recipients": "Recipients",
  "settings.notifications.recipientsHint": "Comma-separated email addresses",
  "settings.notifications.username": "Username",
  "settings.notifications.password": "Password",
  "settings.notifications.apiBase": "Telegram API base",
  "settings.notifications.botToken": "Bot token",
  "settings.notifications.chatId": "Chat ID",
  "settings.notifications.quotaWarning": "Quota warning",
  "settings.notifications.expiryWarning": "Expiry warning",
  "settings.notifications.zeroDisables": "0 disables warning",
  "settings.notifications.hours": "hours",
  "settings.notifications.secretConfigured": "Configured",
  "settings.notifications.testSmtp": "Test SMTP",
  "settings.notifications.testTelegram": "Test Telegram",
  "settings.notifications.lastTest": "Last test",
  ...
  "settings.notifications.testError": "Test notification failed",
...
const ru: Record<keyof typeof en, string> = {
  ...
  "inbounds.transportPath": "Путь",
  "inbounds.transportHost": "Host",
  "inbounds.grpcServiceName": "Имя сервиса",
  ...
  "clients.selectAll": "Выбрать всех клиентов по фильтру",
  "clients.selectClient": "Выбрать {{name}}",
  "clients.selectedCount": "Выбрано: {{count}}",
  "clients.bulkEnable": "Включить",
  "clients.bulkDisable": "Отключить",
  "clients.bulkReset": "Сбросить трафик",
  "clients.bulkDelete": "Удалить",
  "clients.clearSelection": "Очистить",
  "clients.bulkFailures": "Ошибки клиентов",
  "clients.bulkSummary": "Выполнено: {{success}}, ошибок: {{failed}}",
  "clients.bulkRequestFailed": "Не удалось выполнить массовую операцию",
  "clients.bulkDeleteTitle": "Удалить выбранных клиентов?",
  "clients.bulkDeleteBody": "Выбранные клиенты будут удалены безвозвратно: {{count}}.",
  "clients.bulkDeleteConfirm": "Удалить клиентов",
  "clients.bulkResetTitle": "Сбросить выбранный трафик?",
  "clients.bulkResetBody": "Счетчики трафика выбранных клиентов будут обнулены: {{count}}.",
  "clients.bulkResetConfirm": "Сбросить трафик",
  ...
  "settings.notifications.smtp": "SMTP почта",
  "settings.notifications.smtpHint": "Отправка уведомлений через защищенный почтовый сервер",
  "settings.notifications.telegram": "Telegram",
  "settings.notifications.telegramHint": "Отправка уведомлений через Telegram бота",
  "settings.notifications.host": "SMTP хост",
  "settings.notifications.port": "SMTP порт",
  "settings.notifications.security": "Защита соединения",
  "settings.notifications.timeout": "Тайм-аут провайдера",
  "settings.notifications.starttls": "STARTTLS",
  "settings.notifications.implicitTls": "Неявный TLS",
  "settings.notifications.sender": "Отправитель",
  "settings.notifications.recipients": "Получатели",
  "settings.notifications.recipientsHint": "Email адреса через запятую",
  "settings.notifications.username": "Имя пользователя",
  "settings.notifications.password": "Пароль",
  "settings.notifications.apiBase": "Базовый API Telegram",
  "settings.notifications.botToken": "Токен бота",
  "settings.notifications.chatId": "ID чата",
  "settings.notifications.quotaWarning": "Предупреждение о квоте",
  "settings.notifications.expiryWarning": "Предупреждение об истечении",
  "settings.notifications.zeroDisables": "0 отключает предупреждение",
  "settings.notifications.hours": "часов",
  "settings.notifications.secretConfigured": "Настроено",
  "settings.notifications.testSmtp": "Проверить SMTP",
  "settings.notifications.testTelegram": "Проверить Telegram",
  "settings.notifications.lastTest": "Последняя проверка",
  ...
  "settings.notifications.testSent": "Тестовое уведомление отправлено",
  "settings.notifications.testError": "Не удалось отправить тестовое уведомление",
